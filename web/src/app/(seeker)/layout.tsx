...
import { LayoutDashboard, FileText, ShieldCheck, Compass, ClipboardList, Sparkles, MessagesSquare, Inbox, Video } from 'lucide-react';
...
const seekerNav = [
  ...
  { href: '/seeker/interest', label: 'Recruiter Interest', icon: <Inbox className="h-4 w-4" /> },
  { href: '/seeker/interviews', label: 'My Interviews', icon: <Video className="h-4 w-4" /> },
